...
public class At_Tags {
    public static final TagKey<Block> INCORRECT_FOR_GOLD_TOOL = ofblock("incorrect_for_gold_tool");

    public static final TagKey<Block> AXE_MINEABLE = ofblock("mineable/axe");

    public static final TagKey<Block> NEEDS_DIAMOND_TOOL = ofblock("needs_diamond_tool");
    ...
    public static final TagKey<Block> INCORRECT_FOR_OBSIDIAN_TOOL = ofblock("incorrect_for_obsidian_tool");
