...
public final class LootTableReplace {
    ...
    public static Map<ResourceKey<LootTable>, Function<HolderLookup.Provider, LootTable>> LOOT_TABLES = Map.<ResourceKey<LootTable>, Function<HolderLookup.Provider, LootTable>>ofEntries(
        Map.entry(BuiltInLootTables.SPAWN_BONUS_CHEST,
        ...
        Map.entry(BuiltInLootTables.END_CITY_TREASURE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(
                                                LootItem.lootTableItem(MMEItems.ADAMANTIUM_AXE)
                                                        ...
                                                        .apply(EnchantWithLevelsFunction.enchantWithLevels(wrapperLookup, UniformGenerator.between(20.0F, 39.0F)))
                                        )
                                        .add(
        ...
        Map.entry(BuiltInLootTables.VILLAGE_ARMORER,
                wrapperLookup -> 	LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_CARTOGRAPHER,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_MASON,
                wrapperLookup -> 			LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_SHEPHERD,
                wrapperLookup ->
                        LootTable.lootTable()
                                .withPool(
                                        LootPool.lootPool()
        ...
        Map.entry(BuiltInLootTables.VILLAGE_BUTCHER,
                wrapperLookup -> 	LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
        ...
        Map.entry(BuiltInLootTables.VILLAGE_FLETCHER,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_FISHER,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_TANNERY,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 2.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_TEMPLE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_DESERT_HOUSE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_PLAINS_HOUSE,
                wrapperLookup -> 	LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_TAIGA_HOUSE,
                wrapperLookup -> 	LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
        ...
        Map.entry(BuiltInLootTables.VILLAGE_SNOWY_HOUSE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(2.0F, 5.0F))
        ...
        Map.entry(BuiltInLootTables.VILLAGE_SAVANNA_HOUSE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.ABANDONED_MINESHAFT,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        ...
                                        .add(LootItem.lootTableItem(Items.BOOK).setWeight(10).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)))
        ...
        Map.entry(BuiltInLootTables.NETHER_BRIDGE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
        ...
        Map.entry(BuiltInLootTables.STRONGHOLD_LIBRARY,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(Items.BOOK).setWeight(10).apply(EnchantWithLevelsFunction.enchantWithLevels(wrapperLookup, ConstantValue.exactly(25.0F))))
                        )
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
        ...
        Map.entry(BuiltInLootTables.STRONGHOLD_CROSSING,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
                                        ...
                                        .add(LootItem.lootTableItem(Items.BOOK).apply(EnchantWithLevelsFunction.enchantWithLevels(wrapperLookup, ConstantValue.exactly(25.0F))))
                        ).build()
        ),
        Map.entry(BuiltInLootTables.STRONGHOLD_CORRIDOR,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(2.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.DESERT_PYRAMID,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
                                        ...
                                        .add(LootItem.lootTableItem(Items.IRON_HORSE_ARMOR).setWeight(15))
                                        .add(LootItem.lootTableItem(Items.GOLDEN_HORSE_ARMOR).setWeight(10))
                                        .add(LootItem.lootTableItem(Items.BOOK).setWeight(20).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)))
        ...
        Map.entry(BuiltInLootTables.JUNGLE_TEMPLE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.JUNGLE_TEMPLE_DISPENSER,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 2.0F))
        ...
        Map.entry(BuiltInLootTables.IGLOO_CHEST,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.WOODLAND_MANSION,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
                                        ...
                                        .add(LootItem.lootTableItem(Items.BOOK).setWeight(5).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)))
                        )
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.UNDERWATER_RUIN_SMALL,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                        ...
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(MMEItems.COPPER_FISHING_ROD).setWeight(5).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)))
                                        .add(LootItem.lootTableItem(MMEItems.SILVER_FISHING_ROD).setWeight(5).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)))
                                        .add(
        ...
        Map.entry(BuiltInLootTables.UNDERWATER_RUIN_BIG,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
                        ...
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(MMEItems.SILVER_FISHING_ROD).setWeight(5).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.4F, 0.8F))))
                                        .add(LootItem.lootTableItem(MMEItems.COPPER_FISHING_ROD).setWeight(5).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.4F, 0.8F))))
                                        .add(
                                                LootItem.lootTableItem(Items.MAP)
                                                        .setWeight(5)
                                                        .apply(
        ...
        Map.entry(BuiltInLootTables.BURIED_TREASURE,
                wrapperLookup -> LootTable.lootTable()
        ...
        Map.entry(BuiltInLootTables.SHIPWRECK_MAP,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
        ...
        Map.entry(BuiltInLootTables.SHIPWRECK_SUPPLY,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(Items.LEATHER_HELMET).setWeight(3).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.6F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.LEATHER_CHESTPLATE).setWeight(3).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.6F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.LEATHER_LEGGINGS).setWeight(3).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.6F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.LEATHER_BOOTS).setWeight(3).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.6F, 0.9F))))
                        )
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
        ...
        Map.entry(BuiltInLootTables.SHIPWRECK_TREASURE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
        ...
        Map.entry(BuiltInLootTables.PILLAGER_OUTPOST,
                wrapperLookup -> LootTable.lootTable()
                        ...
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(MMEItems.COPPER_ARROW).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                                        .add(LootItem.lootTableItem(MMEItems.SILVER_ARROW).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))))
                                        ...
                                        .add(LootItem.lootTableItem(Items.BOOK).setWeight(1).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)))
                        )
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(0.0F, 1.0F))
        ...
        Map.entry(BuiltInLootTables.BASTION_TREASURE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(2.0F))
        ...
        Map.entry(BuiltInLootTables.BASTION_OTHER,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        ...
                                        .add(LootItem.lootTableItem(Items.BOOK).setWeight(10).apply(new EnchantRandomlyFunction.Builder().withEnchantment(wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.SOUL_SPEED))))
                        )
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(2.0F))
                                        ...
                                        .add(
                                                LootItem.lootTableItem(Items.GOLDEN_BOOTS)
                                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
                                                        .apply(new EnchantRandomlyFunction.Builder().withEnchantment(wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.SOUL_SPEED)))
                                        )
                                        .add(
        ...
        Map.entry(BuiltInLootTables.BASTION_BRIDGE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
        ...
        Map.entry(BuiltInLootTables.BASTION_HOGLIN_STABLE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
        ...
        Map.entry(BuiltInLootTables.ANCIENT_CITY,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(
                                                LootItem.lootTableItem(Items.IRON_HOE)
                                                        ...
                                                        .apply(EnchantWithLevelsFunction.enchantWithLevels(wrapperLookup, UniformGenerator.between(30.0F, 50.0F)))
                                        )
                                        ...
                                        .add(LootItem.lootTableItem(Items.BOOK).setWeight(3).apply(new EnchantRandomlyFunction.Builder().withEnchantment(wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.SWIFT_SNEAK))))
        ...
        Map.entry(BuiltInLootTables.ANCIENT_CITY_ICE_BOX,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(2.0F, 5.0F))
        ...
        Map.entry(BuiltInLootTables.RUINED_PORTAL,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 2.0F))
                                        ...
                                        .add(LootItem.lootTableItem(Items.GOLDEN_SWORD).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.8F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.GOLDEN_AXE).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.8F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.GOLDEN_HOE).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.8F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.GOLDEN_SHOVEL).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.8F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.GOLDEN_PICKAXE).setWeight(3).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.8F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.GOLDEN_BOOTS).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.8F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.GOLDEN_CHESTPLATE).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.8F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.GOLDEN_HELMET).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.8F, 0.9F))))
                                        .add(LootItem.lootTableItem(Items.GOLDEN_LEGGINGS).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(wrapperLookup)).apply(SetItemDamageFunction.setDamage(UniformGenerator.between(0.8F, 0.9F))))
        ...
        Map.entry(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_COMMON,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
        ...
        Map.entry(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_RARE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        ...
                                        .add(LootItem.lootTableItem(MMEItems.MITHRIL_BOW).setWeight(3).apply(EnchantWithLevelsFunction.enchantWithLevels(wrapperLookup, UniformGenerator.between(20.0F, 30.0F))))
                                        .add(
                                                LootItem.lootTableItem(Items.CROSSBOW).setWeight(2).apply(EnchantWithLevelsFunction.enchantWithLevels(wrapperLookup, UniformGenerator.between(5.0F, 20.0F)))
                                        )
                                        .add(
                                                ...
                                                LootItem.lootTableItem(Items.BOOK)
                                                        ...
                                                        .apply(
                                                                new EnchantRandomlyFunction.Builder()
                                                                        .withOneOf(
                                                                                HolderSet.direct(
                                                                                        wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.SHARPNESS),
                                                                                        wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.BANE_OF_ARTHROPODS),
                                                                                        wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.EFFICIENCY),
                                                                                        wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.FORTUNE),
                                                                                        wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.SILK_TOUCH),
                                                                                        wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.FEATHER_FALLING)
                                                                                )
                                                                        )
                                                        )
                                        )
                                                                ...
                                                                new EnchantRandomlyFunction.Builder()
                                                                        .withOneOf(
                                                                                HolderSet.direct(
                                                                                         ...
                                                                                         wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.MENDING)
                                                                                )
                                                                        )
                                                        )
                                        )
        ...
        Map.entry(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_UNIQUE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(Items.NETHERITE_SWORD).apply(EnchantWithLevelsFunction.enchantWithLevels(wrapperLookup, UniformGenerator.between(40.0F, 50.0F))))
                        ).build()
        ),
        Map.entry(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_COMMON,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        ...
                                        .add(
                                                LootItem.lootTableItem(Items.CROSSBOW).setWeight(4).apply(EnchantWithLevelsFunction.enchantWithLevels(wrapperLookup, UniformGenerator.between(5.0F, 20.0F)))
                                        )
                                        ...
                                        .add(
                                                LootItem.lootTableItem(Items.BOOK)
                                                        .setWeight(2)
                                                        .apply(
                                                                new EnchantRandomlyFunction.Builder().withOneOf(HolderSet.direct(wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.BREACH), wrapperLookup.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(Enchantments.DENSITY)))
                                                        )
                                        )
                                        .add(
                                                LootItem.lootTableItem(Items.BOOK)
        ...
        Map.entry(BuiltInLootTables.TRIAL_CHAMBERS_SUPPLY,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(2.0F, 3.0F))
        ...
        Map.entry(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 2.0F))
        ...
        Map.entry(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 2.0F))
        ...
        Map.entry(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION_BARREL,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 2.0F))
        ...
        Map.entry(BuiltInLootTables.TRIAL_CHAMBERS_ENTRANCE,
                wrapperLookup -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(1.0F, 3.0F))
