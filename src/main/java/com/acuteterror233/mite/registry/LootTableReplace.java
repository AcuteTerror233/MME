                ...
                provider -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_YLEM_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_SANCT_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_NUL_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_QUAS_RUNESTORE).setWeight(5))
                                        .add(
                ...
                provider -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(MMEItems.MITHRIL_BOW).setWeight(3).apply(EnchantWithLevelsFunction.enchantWithLevels(provider, UniformGenerator.between(20.0F, 30.0F))))
                                        .add(
                                        ...
                                        .add(
                                                LootItem.lootTableItem(MMEItems.MITHRIL_AXE).setWeight(2).apply(EnchantWithLevelsFunction.enchantWithLevels(provider, UniformGenerator.between(20.0F, 30.0F)))
                                        )
                                        .add(
                                                LootItem.lootTableItem(MMEItems.MITHRIL_BATTLE_AXE).setWeight(2).apply(EnchantWithLevelsFunction.enchantWithLevels(provider, UniformGenerator.between(20.0F, 30.0F)))
                                        )
                                        .add(
                                        ...
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_POR_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_AN_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_NOX_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_FLAM_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_VAS_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_DES_RUNESTORE).setWeight(5))
                                        .add(
                ...
                provider -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_ORT_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_TYM_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_CORP_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_LOR_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_MANI_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.MITHRIL_JUX_RUNESTORE).setWeight(5))
                        )
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(UniformGenerator.between(0.0F, 1.0F))
                                        .add(EmptyLootItem.emptyItem().setWeight(99))
                                        .add(LootItem.lootTableItem(Items.NETHERITE_SWORD).apply(EnchantWithLevelsFunction.enchantWithLevels(provider, UniformGenerator.between(40.0F, 50.0F))))
                        ).build()
        );
                ...
                provider -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_YLEM_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_SANCT_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_NUL_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_QUAS_RUNESTORE).setWeight(5))
                                        .add(
                                        ...
                                        .add(
                                                LootItem.lootTableItem(MMEItems.ADAMANTIUM_CHESTPLATE)
                                                        .setWeight(3)
                                                        .apply(EnchantWithLevelsFunction.enchantWithLevels(provider, UniformGenerator.between(20.0F, 25.0F)))
                                        )
                                        .add(
                                                LootItem.lootTableItem(MMEItems.ADAMANTIUM_HELMET)
                                                        .setWeight(3)
                                                        .apply(EnchantWithLevelsFunction.enchantWithLevels(provider, UniformGenerator.between(20.0F, 25.0F)))
                                        )
                                        .add(
                ...
                provider -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_POR_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_AN_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_NOX_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_FLAM_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_VAS_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_DES_RUNESTORE).setWeight(5))
                        ).build()
        );
        LOOT_TABLES.put(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_UNIQUE,
                provider -> LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_ORT_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_TYM_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_CORP_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_LOR_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_MANI_RUNESTORE).setWeight(5))
                                        .add(LootItem.lootTableItem(MMEBlocks.ADAMANTIUM_JUX_RUNESTORE).setWeight(5))
