...
public class UndergroundOrePlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> featureRegisterable){
        ...
        Holder<ConfiguredFeature<?, ?>> ore_adamantium_buried = registryEntryLookup.getOrThrow(UndergroundOreConfiguredFeatures.ORE_ADAMANTIUM_BURIED);
        Holder<ConfiguredFeature<?, ?>> ore_adamantium_buried_small = registryEntryLookup.getOrThrow(UndergroundOreConfiguredFeatures.ORE_ADAMANTIUM_BURIED_SMALL);
        Holder<ConfiguredFeature<?, ?>> ore_mithril = registryEntryLookup.getOrThrow(UndergroundOreConfiguredFeatures.ORE_MITHRIL);
        Holder<ConfiguredFeature<?, ?>> ore_mithril_small = registryEntryLookup.getOrThrow(UndergroundOreConfiguredFeatures.ORE_MITHRIL_SMALL);
