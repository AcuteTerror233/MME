    ...
    public static final Map<ResourceLocation, Function<BlockBehaviour.Properties, Block>> BLOCK_FACTORY_MODIFY = Map.ofEntries(
            ...
            Map.entry(ResourceLocation.withDefaultNamespace("furnace"), settings -> new GradeFurnaceBlock(
                    BlockBehaviour.Properties.of()
                            ...
                            .strength(0.3F)
                            .lightLevel(Blocks.litBlockEmission(13)), 2)
            ),
            Map.entry(ResourceLocation.withDefaultNamespace("blast_furnace"), settings -> new GradeFurnaceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FURNACE), 0)),
            Map.entry(ResourceLocation.withDefaultNamespace("smoker"), settings -> new GradeFurnaceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FURNACE), 1))
    );
