...
public abstract class AbstractCraftingTableScreenHandler extends AbstractLevelCraftingScreenHandler{
    private final ScreenHandlerContext context;
    private final PlayerEntity player;
    private boolean filling;
    public AbstractCraftingTableScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        super(AtBlocks.CRAFTINGTABLESCREENHANDLER, syncId, 3, 3);
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(this.context, player, AtBlocks.ACS);
    }
    @Override
