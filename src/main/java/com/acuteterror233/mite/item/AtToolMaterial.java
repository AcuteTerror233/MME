...
public class AtToolMaterial {
    ...
    public static final ToolMaterial MITHRIL = new ToolMaterial(AtTags.INCORRECT_FOR_MITHRIL_TOOL, 256, 8.0F, 3.0F, 10, AtTags.MITHRIL_TOOL_MATERIALS);
    ...
    public static final ToolMaterial FLINT = new ToolMaterial(AtTags.INCORRECT_FOR_FLINT_TOOL, 4, 8.0F, 3.0F, 10, AtTags.FLINT_TOOL_MATERIALS);
}
