...
public class MMEToolMaterials {
    public static final ToolMaterial NETHERITE = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 256, 14.0F, 8.0F, 24, ItemTags.NETHERITE_TOOL_MATERIALS);
    public static final ToolMaterial ADAMANTIUM = new ToolMaterial(MMETags.INCORRECT_FOR_ADAMANTIUM_TOOL, 128, 12.0F, 7.0F, 21, MMETags.ADAMANTIUM_TOOL_MATERIALS);
    public static final ToolMaterial MITHRIL = new ToolMaterial(MMETags.INCORRECT_FOR_MITHRIL_TOOL, 64, 10.0F, 6.0F, 18, MMETags.MITHRIL_TOOL_MATERIALS);
    public static final ToolMaterial ANCIENT_METAL = new ToolMaterial(MMETags.INCORRECT_FOR_ANCIENT_METAL_TOOL, 32, 9.0F, 5.0F, 15, MMETags.ANCIENT_METAL_TOOL_MATERIALS);
    public static final ToolMaterial RUSTED_IRON = new ToolMaterial(MMETags.INCORRECT_FOR_RUSTED_IRON_TOOL, 8, 6.0F, 3.0F, 10, MMETags.RUSTED_IRON_TOOL_MATERIALS);
    public static final ToolMaterial IRON = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 16, 8.0F, 4.0F, 12, ItemTags.IRON_TOOL_MATERIALS);
