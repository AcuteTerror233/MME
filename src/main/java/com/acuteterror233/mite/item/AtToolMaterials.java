...
public class AtToolMaterials {
    public static final ToolMaterial ADAMANTIUM = new ToolMaterial(AtTags.INCORRECT_FOR_ADAMANTIUM_TOOL, 512, 12.0F, 7.0F, 22, AtTags.ADAMANTIUM_TOOL_MATERIALS);
    ...
    public static final ToolMaterial MITHRIL = new ToolMaterial(AtTags.INCORRECT_FOR_MITHRIL_TOOL, 256, 8.0F, 6.0F, 10, AtTags.MITHRIL_TOOL_MATERIALS);
    ...
    public static final ToolMaterial FLINT = new ToolMaterial(AtTags.INCORRECT_FOR_FLINT_TOOL, 4, 8.0F, 2.0F, 10, AtTags.FLINT_TOOL_MATERIALS);
}
