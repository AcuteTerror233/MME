...
public class AtToolMaterials {
    ...
    public static final ToolMaterial MITHRIL = new ToolMaterial(AtTags.INCORRECT_FOR_MITHRIL_TOOL, 256, 10.0F, 6.0F, 18, AtTags.MITHRIL_TOOL_MATERIALS);
    ...
    public static final ToolMaterial COPPER = new ToolMaterial(AtTags.INCORRECT_FOR_COPPER_OR_SILVER_TOOL, 8, 4.0F, 3.0F, 10, AtTags.COPPER_TOOL_MATERIALS);
    public static final ToolMaterial SILVER = new ToolMaterial(AtTags.INCORRECT_FOR_COPPER_OR_SILVER_TOOL, 8, 4.0F, 3.0F, 10, AtTags.SILVER_TOOL_MATERIALS);
