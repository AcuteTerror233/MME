...
public class AtAnvilScreen extends ForgingScreen<AtAnvilScreenHandler> {
    ...
    public AtAnvilScreen(AtAnvilScreenHandler handler, PlayerInventory inventory, Text title) {
