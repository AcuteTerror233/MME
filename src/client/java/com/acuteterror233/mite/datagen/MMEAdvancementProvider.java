...
public class MMEAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(HolderLookup.Provider registryLookup, Consumer<AdvancementHolder> consumer) {
        ...
        AdvancementHolder storyRoot = Advancement.Builder.advancement()
                ...
                .addCriterion("root", InventoryChangeTrigger.TriggerInstance.hasItems(Items.GRAVEL))
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/root"));
        AdvancementHolder wheat_seeds = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/wheat_seeds"));
        AdvancementHolder egg = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/egg"));
        AdvancementHolder clay_furnace = Advancement.Builder.advancement()
                .parent(storyRoot)
                .display(
                        com.acuteterror233.mite.item.MMEItems.CLAY_FURNACE,
                ...
                .addCriterion("get_clay_furnace", InventoryChangeTrigger.TriggerInstance.hasItems(MMEItems.CLAY_FURNACE))
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/clay_furnace"));
        AdvancementHolder torch = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/torch"));
        AdvancementHolder flint = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/flint"));
        AdvancementHolder flint_hatchet = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/flint_hatchet"));
        AdvancementHolder log = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/log"));
        AdvancementHolder crafting_table = Advancement.Builder.advancement()
                .parent(log)
                .display(
                        MMEItems.FLINT_CRAFTING_TABLE,
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/crafting_table"));
        AdvancementHolder leather = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/leather"));
        AdvancementHolder leatherArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/leather_armor"));
        AdvancementHolder flint_axe = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/flint_axe"));
        AdvancementHolder flint_shovel = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/flint_shovel"));
        AdvancementHolder cudgel = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/cudgel"));
        AdvancementHolder copperNugget = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/copper_nugget"));
        AdvancementHolder metalCraftingTable = Advancement.Builder.advancement()
                .parent(copperNugget)
                .display(
                        MMEItems.COPPER_CRAFTING_TABLE,
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/metal_crafting_table"));
        AdvancementHolder mineStone = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/mine_stone"));
        AdvancementHolder betterArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/better_armor"));
        AdvancementHolder pickaxe = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/upgrade_tools"));
        AdvancementHolder fishingGo = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/fishing_go"));
        AdvancementHolder deliciousFish = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/delicious_fish"));
        AdvancementHolder smeltIron = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/smelt_iron"));
        AdvancementHolder ironPickaxe = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/iron_tools"));
        AdvancementHolder mithril = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/mithril"));
        AdvancementHolder mineDiamond = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/mine_diamond"));
        AdvancementHolder lavaBucket = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/lava_bucket"));
        AdvancementHolder obtainArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/obtain_armor"));
        AdvancementHolder enchantItem = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/enchant_item"));
        AdvancementHolder formObsidian = Advancement.Builder.advancement()
                ...
                .addCriterion("obsidian", InventoryChangeTrigger.TriggerInstance.hasItems(Items.OBSIDIAN))
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/form_obsidian"));
        AdvancementHolder shinyGear = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/shiny_gear"));
        AdvancementHolder enterUnderground = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/enter_the_underground"));
        AdvancementHolder enterNether = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/enter_the_nether"));
        AdvancementHolder cureZombieVillager = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/cure_zombie_villager"));
        AdvancementHolder followEnderEye = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/follow_ender_eye"));
        AdvancementHolder enterEnd = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "story/enter_the_end"));

        AdvancementHolder undergroundRoot = Advancement.Builder.advancement()
                .rootDisplay(
                        Items.DEEPSLATE.asItem(),
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/root"));
        AdvancementHolder findAncientMetal = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/find_ancient_metal"));
        AdvancementHolder ancientMetalCraftingTable = Advancement.Builder.advancement()
                .parent(findAncientMetal)
                .display(
                        MMEItems.ANCIENT_METAL_CRAFTING_TABLE,
                ...
                .addCriterion("get_ancient_metal_crafting_table", InventoryChangeTrigger.TriggerInstance.hasItems(MMEItems.ANCIENT_METAL_CRAFTING_TABLE))
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/ancient_metal_crafting_table"));
        AdvancementHolder mithrilTool = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/mithril_tool"));
        AdvancementHolder findAdamantium = Advancement.Builder.advancement()
                .parent(mithrilTool)
                .display(
                        MMEItems.ADAMANTIUM_ORE,
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/find_adamantium"));
        AdvancementHolder smeltAdamantium = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/smelt_adamantium"));
        AdvancementHolder adamantiumTool = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/adamantium_tool"));
        AdvancementHolder adamantiumArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/adamantium_armor"));
        AdvancementHolder enterAncientCity = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/enter_ancient_city"));
        AdvancementHolder deepDown = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/deep_down"));
        AdvancementHolder mantlePortal = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(MME.MOD_ID, "underground/mantle_portal"));
    }
}
