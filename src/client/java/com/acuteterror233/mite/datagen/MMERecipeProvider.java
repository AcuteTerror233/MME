...
public class MMERecipeProvider extends FabricRecipeProvider {
    ...
    public MMERecipeProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
    ...
    protected @NotNull RecipeProvider createRecipeProvider(HolderLookup.@NonNull Provider registryLookup, BootstrapContext<Recipe<?>> recipes, BootstrapContext<Advancement> advancements) {
        return new RecipeProvider(recipes, advancements) {
            ...
            public void buildRecipes() {
                ...
                this.oreSmelting(MITHRIL_SMELTABLES, RecipeCategory.MISC, CookingBookCategory.MISC, MMEItems.MITHRIL_INGOT, 2.0F, 200, "mithril_ingot");
                this.oreSmelting(SILVER_SMELTABLES, RecipeCategory.MISC, CookingBookCategory.MISC, MMEItems.SILVER_INGOT, 0.7F, 200, "silver_ingot");
                ...
                SimpleCookingRecipeBuilder.blasting(
                        ...
                        .unlockedBy("has_ancient_metal_spear", this.has(MMEItems.ANCIENT_METAL_SPEAR))
                ...
                SimpleCookingRecipeBuilder.blasting(
                        ...
                        .unlockedBy("has_rusted_iron_spear", this.has(MMEItems.RUSTED_IRON_SPEAR))
                ...
                SimpleCookingRecipeBuilder.blasting(
                        ...
                        .unlockedBy("has_silver_spear", this.has(MMEItems.SILVER_SPEAR))
                ...
                SimpleCookingRecipeBuilder.blasting(
                        ...
                        .unlockedBy("has_adamantium_spear", this.has(MMEItems.ADAMANTIUM_SPEAR))
                ...
                SimpleCookingRecipeBuilder.blasting(
                        ...
                        .unlockedBy("has_netherite_spear", this.has(Items.NETHERITE_SPEAR))
                ...
                shaped(RecipeCategory.DECORATIONS, MMEBlocks.TERRACOTTA_FURNACE)
                ...
                offerSwordRecipes(Items.IRON_INGOT, MMEItems.RUSTED_IRON_SPEAR);
                offerSwordRecipes(Items.FLINT, MMEItems.FLINT_SPEAR);
            ...
            private void offerSpearRecipes(Item ingot, Item Spear) {
                shaped(RecipeCategory.TOOLS, Spear)
                        .define('a', ingot)
                        .define('b', Items.STICK)
                        .pattern("  b")
                        .pattern(" a ")
